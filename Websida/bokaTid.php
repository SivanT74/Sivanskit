...
<div class="navbar">
    ...
    <div class="content">
                ...
                <?php
                  ...
                  $ch = curl_init($baseurl . '/api/resource/Patient%20Appointment/?fields=["appointment_date","appointment_time","appointment_type","department","name"]&limit_page_length=500?filters=["patient_name","=","Namn"]');
